...
def main():
    ...
    parser = argparse.ArgumentParser(description='Test YOLOv10 model on test dataset')
    parser.add_argument('--model', type=str, required=True,
                       help='Path to model weights (e.g., models/detectors/yolov10/train/weights/best.pt)')
